...
def cmd_create(platform: str, username: str, metric_type: str, target_value: str, deadline: str, video_id: str = ""):
    ...
    # createMarket now takes ONE tuple matching the Solidity CreateMarketParams struct,
    # in the exact same field order — web3.py accepts a plain Python tuple here.
    create_params = (question, close_time, platform_code, username, video_id, metric_code, target_int)

    tx = contract.functions.createMarket(create_params).build_transaction({
