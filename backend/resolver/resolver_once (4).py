...
# Contract stores these as uint8 enums; metrics_client works with strings.
...
def process_market(w3: Web3, contract, account, market_id: int) -> None:
    # getMarket now returns the full Market struct as ONE tuple (11 fields, including
    # measuredValue which is 0/unused until resolved) rather than 10 loose values —
    # web3.py still hands it back as a plain Python tuple, so unpacking looks the same.
